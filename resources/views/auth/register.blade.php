                ...
                <div class="row d-flex justify-content-between">
                    ...
                    <div class="col-md-4">
                        <img src="{{ asset('images/LaudoHSJ.png') }}"
                            style="width: 85px; margin-top: 20%; margin-left:50%;" />
                    </div>
                </div>
                <div class="card">
                    <div class="card-header" style="background-color: #e4e4e4">{{ __('Cadastro') }}</div>
                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group row">
                                <label for="password-confirm"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Confirme Senha') }}</label>
